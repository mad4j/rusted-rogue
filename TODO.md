...
[x] Blocking messages (e.g. "The orc hits you") | Original: Message blocks input until acknowledged. Rust port: Messages are non-blocking overlays; player can continue acting while messages are visible. |
